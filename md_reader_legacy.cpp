/*
    Compile with:
    g++ -std=c++11 -O3 md_reader_legacy.cpp -lchemfiles -o md_reader_legacy
...
int main() {
    try {
        std::string dataset_dir = "./dataset_legacy/1k5n/";
        std::string topology_file = dataset_dir+ "1k5n_A.pdb";
        std::string output_file = "output/snapshots_coords_0.bin";
        ...
        auto info_R1 = write_trajectory_to_file(dataset_dir+ "1k5n_A_prod_R1_fit.xtc", topology, outfile);
        total_frames += info_R1.n_frames;
        n_atoms = info_R1.n_atoms;
        
        // Process R2
        std::cout << "\nReading R2 trajectory..." << std::endl;
        auto info_R2 = write_trajectory_to_file(dataset_dir + "1k5n_A_prod_R2_fit.xtc", topology, outfile);
        total_frames += info_R2.n_frames;
        
        // Process R3
        std::cout << "\nReading R3 trajectory..." << std::endl;
        auto info_R3 = write_trajectory_to_file(dataset_dir + "1k5n_A_prod_R3_fit.xtc", topology, outfile);
